...
<div class="col-xs-12">
		...
		<h1>Lista de reportes de errores de picking</h1>
    <br>
  <!-- <p> Mostrar cantidad de <select name="sel" id="value"> 
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#create">
				<span class="glyphicon glyphicon-plus"></span> Nuevo reporte   <i class="fa fa-plus"></i> </a></button>
...
?>
  ...
  <br>
      ...
      <table class="table table-striped table-dark table_id " id="table_id">
                        ...
                        <th>Fecha picking</th>
                        <th>Hora picking</th>
                        <th>Mediad unitaria</th>
                        <th>Cantidad</th>
                        <th>Imagen o imagenes</th>
                        <th>Mes</th>
                        <th>Usuario</th>
                        <th>Jefatura</th>
                        <th>Acciones</th>
...
$conexion=mysqli_connect("localhost","root","","r_user");               
$SQL=mysqli_query($conexion,"SELECT reportes.id, reportes.viajes, reportes.fecha-reporte, reportes.fecha-picking,
 reportes.hora, reportes.medida-unitaria, reportes.imagen, permisos.rol FROM user
...
<td><?php echo $fila['fecha-reporte']; ?></td>
<td><?php echo $fila['fecha-picking']; ?></td>
<td><?php echo $fila['hora']; ?></td>
<td><?php echo $fila['medida-unitaria']; ?></td>
